...
const RAW_ITEMS: ContentItem[] = [
...

  {
    ...
    tags: ['hard-techno', 'industrial', 'ebm', 'dark-techno', 'live', 'cdmx', '2026'],
    ...
    embeds: [
      { platform: 'soundcloud', url: 'https://soundcloud.com/espectrofm/mix-001-siete-catorce' },
      { platform: 'youtube', url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ' },
      { platform: 'spotify', url: 'https://open.spotify.com/episode/placeholder-mix-001' },
      { platform: 'bandcamp', url: 'https://espectrofm.bandcamp.com/album/mix-001' },
    ],
...

  {
    ...
    embeds: [
      { platform: 'soundcloud', url: 'https://soundcloud.com/espectrofm/mix-002-rat-pack' },
      { platform: 'youtube', url: 'https://www.youtube.com/watch?v=placeholder-002' },
    ],
...

  {
    ...
    excerpt: 'Un recuento editorial de las piezas que marcaron el año en la escena hard techno de la Ciudad de México. De lo industrial al acelere, del rave de Japan a los after-hours. Sin rankings de popularidad — curaduría pura.',
    vibe: 9,
    ...
    articleBody: [
      ...
      { kind: 'divider' },
      {
        ...
        imageUrl: '/flyers/rf-015.jpg',
        embeds: [
          { platform: 'soundcloud', url: 'https://soundcloud.com/perctrax/forward-pressure' },
          { platform: 'youtube', url: 'https://www.youtube.com/watch?v=example-perc' },
          { platform: 'bandcamp', url: 'https://perctrax.bandcamp.com/track/forward-pressure' },
        ],
        commentary:
      ...
      },
      {
        ...
        imageUrl: '/flyers/rf-016.jpg',
        embeds: [
          { platform: 'soundcloud', url: 'https://soundcloud.com/ansome/systematic-behavior' },
          { platform: 'spotify', url: 'https://open.spotify.com/track/placeholder-ansome' },
        ],
        commentary:
      ...
      },
      {
        ...
        imageUrl: '/flyers/rf-017.jpg',
        embeds: [
          { platform: 'soundcloud', url: 'https://soundcloud.com/phasefatale/descent' },
          { platform: 'bandcamp', url: 'https://phasefatale.bandcamp.com/track/descent' },
        ],
        commentary:
      ...
      },
      {
        ...
        imageUrl: '/flyers/rf-018.jpg',
        embeds: [
          { platform: 'soundcloud', url: 'https://soundcloud.com/downwards/collapse' },
          { platform: 'youtube', url: 'https://www.youtube.com/watch?v=example-regis' },
          { platform: 'bandcamp', url: 'https://downwards.bandcamp.com/track/collapse' },
        ],
        commentary:
      ...
      { kind: 'divider' },
      {
        ...
        imageUrl: '/flyers/rf-019.jpg',
        embeds: [
          { platform: 'soundcloud', url: 'https://soundcloud.com/ancientmethods/mutilate' },
          { platform: 'youtube', url: 'https://www.youtube.com/watch?v=example-am' },
          { platform: 'spotify', url: 'https://open.spotify.com/track/placeholder-am' },
          { platform: 'bandcamp', url: 'https://ancientmethods.bandcamp.com/track/mutilate' },
        ],
        commentary:
...

  {
    ...
    excerpt: 'Mayo trae el cierre de temporada antes del bajón de calor. Esta es la curaduría editorial de los cinco eventos del mes que no deberías saltarte: cinco contextos distintos, cinco intenciones distintas. Ningún top arbitrario — el orden refleja calendario inverso, no jerarquía.',
    vibe: 7,
    ...
    articleBody: [
      ...
      },
      {
        ...
        alt: 'Donato Dozzy',
        caption: 'Jueves 15 de mayo · 21:00 → 02:00 · Foro Indie Rocks, Roma Norte',
      },
      {
        kind: 'p',
      ...
      },
      {
        ...
        alt: 'FASCiNOMA 2026',
        caption: 'Sábado 24 de mayo · 14:00 → 02:00 · Espacio al aire libre · CDMX',
      },
      {
        kind: 'p',
...

  {
    ...
    excerpt: 'No es la lista de los hits del momento — es la de los cortes que se quedaron pegados en los DJ booths de la ciudad durante mayo, junio y julio. Mucho house orgánico, breaks suaves, electro de pista alta y disco italiano de los tardes. Cuenta regresiva editorial.',
    vibe: 6,
    genres: ['house', 'organic-house', 'deep-house', 'breaks', 'electro', 'nu-disco', 'minimal'],
    ...
    articleBody: [
      ...
      { kind: 'divider' },
      {
        ...
        imageUrl: '/flyers/rf-014.jpg',
        embeds: [
          { platform: 'soundcloud', url: 'https://soundcloud.com/maeve/memory-mayotte' },
          { platform: 'spotify', url: 'https://open.spotify.com/track/placeholder-mayotte' },
        ],
        commentary:
      ...
      },
      {
        ...
        imageUrl: '/flyers/rf-015.jpg',
        embeds: [
          { platform: 'soundcloud', url: 'https://soundcloud.com/dial-records/cliff-hanger' },
          { platform: 'bandcamp', url: 'https://dial-records.bandcamp.com/track/cliff-hanger' },
        ],
        commentary:
      ...
      },
      {
        ...
        imageUrl: '/flyers/rf-016.jpg',
        embeds: [
          { platform: 'soundcloud', url: 'https://soundcloud.com/hagan/cosmic-funk' },
          { platform: 'youtube', url: 'https://www.youtube.com/watch?v=placeholder-hagan' },
          { platform: 'spotify', url: 'https://open.spotify.com/track/placeholder-hagan' },
        ],
        commentary:
      ...
      },
      {
        ...
        imageUrl: '/flyers/rf-017.jpg',
        embeds: [
          { platform: 'soundcloud', url: 'https://soundcloud.com/anz/inna-circle' },
          { platform: 'bandcamp', url: 'https://anz.bandcamp.com/track/inna-circle' },
        ],
        commentary:
      ...
      },
      {
        ...
        imageUrl: '/flyers/rf-018.jpg',
        embeds: [
          { platform: 'soundcloud', url: 'https://soundcloud.com/karenn/edible-pulse' },
          { platform: 'spotify', url: 'https://open.spotify.com/track/placeholder-karenn' },
        ],
        commentary:
      ...
      { kind: 'divider' },
      {
        ...
        imageUrl: '/flyers/rf-019.jpg',
        embeds: [
          { platform: 'soundcloud', url: 'https://soundcloud.com/ilian-tape/dolomite-drift' },
          { platform: 'bandcamp', url: 'https://ilian-tape.bandcamp.com/track/dolomite-drift' },
          { platform: 'spotify', url: 'https://open.spotify.com/track/placeholder-skee' },
        ],
        commentary:
      ...
      },
      {
        ...
        imageUrl: '/flyers/rf-020.jpg',
        embeds: [
          { platform: 'soundcloud', url: 'https://soundcloud.com/pluto/vacuum-boogie-2' },
          { platform: 'youtube', url: 'https://www.youtube.com/watch?v=placeholder-fp' },
        ],
        commentary:
      ...
      },
      {
        ...
        imageUrl: '/flyers/rf-014.jpg',
        embeds: [
          { platform: 'soundcloud', url: 'https://soundcloud.com/siete-catorce/mareada' },
          { platform: 'bandcamp', url: 'https://sietecatorce.bandcamp.com/track/mareada' },
          { platform: 'spotify', url: 'https://open.spotify.com/track/placeholder-714' },
        ],
        commentary:
      ...
      },
      {
        ...
        imageUrl: '/flyers/rf-015.jpg',
        embeds: [
          { platform: 'soundcloud', url: 'https://soundcloud.com/hyperdub/glass-notes' },
          { platform: 'bandcamp', url: 'https://loraine-james.bandcamp.com/track/glass-notes' },
        ],
        commentary:
      ...
      { kind: 'divider' },
      {
        ...
        imageUrl: '/flyers/rf-016.jpg',
        embeds: [
          { platform: 'soundcloud', url: 'https://soundcloud.com/donato-dozzy/marea-lunare' },
          { platform: 'youtube', url: 'https://www.youtube.com/watch?v=placeholder-dozzy' },
          { platform: 'spotify', url: 'https://open.spotify.com/track/placeholder-dozzy' },
          { platform: 'bandcamp', url: 'https://donato-dozzy.bandcamp.com/track/marea-lunare' },
        ],
        commentary:
