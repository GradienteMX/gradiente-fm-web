...
const RAW_ITEMS: ContentItem[] = [
...

  {
    ...
    editorial: true,
    poll: {
      id: "pl-fascinoma-2026-asistencia",
      kind: "attendance",
      prompt: "Vas a FASCiNOMA?",
      closesAt: "2026-05-22T14:00:00",
...

  {
    ...
    poll: {
      id: "pl-mx-001-mejor-track",
      kind: "from-tracklist",
      prompt: "Mejor track del set?",
...

  {
    ...
    editorial: true,
    poll: {
      id: "pl-no-001-headliner",
      kind: "freeform",
      prompt: "Headliner que más quieres ver?",
      choices: [
        { id: "ch-surgeon", label: "Surgeon" },
        { id: "ch-dozzy", label: "Donato Dozzy" },
        { id: "ch-reni", label: "re:ni" },
        { id: "ch-debit", label: "Debit (live)" },
        { id: "ch-alpha-omega", label: "Alpha & Omega (live)" },
      ],
      createdAt: "2026-04-15T09:30:00",
    },
  },
...

  {
    ...
    footnotes: [],
    poll: {
      id: "pl-hard-techno-cdmx-favorito",
      kind: "from-list",
      prompt: "Tu favorito?",
...

  {
    ...
    marketplaceListings: [
      {
        id: "mkl-naafi-01",
        title: "Siete Catorce — Volcán",
        category: "vinyl",
        subcategory: "12\"",
        price: 450,
        condition: "NM",
        images: ["/flyers/rf-074.jpg", "/flyers/rf-075.jpg", "/flyers/rf-076.jpg"],
        status: "available",
        tags: ["limited", "club-music", "mexico"],
        shippingMode: "both",
        embeds: [
          { platform: "soundcloud", url: "https://soundcloud.com/sietecatorce/volcan-preview" },
          { platform: "youtube", url: "https://youtube.com/watch?v=naafi-volcan-preview" },
        ],
        description:
          "Edición limitada del LP Volcán de Siete Catorce. Prensaje de 300 copias en vinilo negro de 180g, jacket mate con impresión letterpress. Incluye descarga digital. Pocas unidades restantes.",
        publishedAt: "2026-04-25T10:00:00",
      },
      {
        id: "mkl-naafi-02",
        title: "Girl Ultra — Sofía 12\"",
        category: "vinyl",
        subcategory: "12\"",
        price: 520,
        condition: "NEW",
        images: ["/flyers/rf-077.jpg", "/flyers/rf-078.jpg"],
        status: "available",
        tags: ["sealed", "r&b", "first-press"],
        shippingMode: "both",
        publishedAt: "2026-04-22T10:00:00",
      },
      {
        id: "mkl-naafi-03",
        title: "BLAKK — Máquina Negra (cassette)",
        category: "cassette",
        subcategory: "Album",
        price: 250,
        condition: "NEW",
        images: [],
        status: "available",
        tags: ["sealed", "industrial"],
        shippingMode: "both",
        publishedAt: "2026-04-20T10:00:00",
      },
      {
        id: "mkl-naafi-04",
        title: "N.A.A.F.I. 10 Años — Camiseta",
        category: "merch",
        ...
        images: [],
        status: "reserved",
        tags: ["aniversario", "talla-M"],
        shippingMode: "shipping",
        publishedAt: "2026-04-18T10:00:00",
      },
      {
        id: "mkl-naafi-05",
        title: "Debit — Live Recordings 2024–25",
        category: "cassette",
        subcategory: "Mixtape",
        price: 200,
        condition: "VG+",
      ...
      {
        id: "mkl-naafi-06",
        title: "Tatiana Heuman — Sismograma 12\"",
        category: "vinyl",
        subcategory: "12\"",
        price: 420,
        condition: "VG+",
