      ...
      <div className="flex flex-col gap-5">
        <Section label="01" title="IDENTIDAD">
          <TextField
            ...
            placeholder="La escena no es una marca"
            required
          />
          <TextField
            label="SUBTÍTULO / DEK"
            ...
            placeholder="Por qué la institucionalización mata lo underground"
          />
          <TextField
            label="SLUG"
            value={draft.slug}
            ...
            placeholder="la-escena-no-es-marca"
            mono
            required
          />
          <TextField
