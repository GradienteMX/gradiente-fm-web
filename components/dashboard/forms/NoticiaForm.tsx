...
export function NoticiaForm() {
  ...
  const errors: string[] = []
  if (!draft.title) errors.push('TITULAR')
      ...
      <div className="flex flex-col gap-5">
        <Section label="01" title="IDENTIDAD">
          <TextField
            ...
            placeholder="FASCiNOMA anuncia line-up 2026"
            required
          />
          <TextField
            label="SLUG"
          ...
          />
          <Toggle
            label="EDITORIAL (raro para noticia, usar con criterio)"
        ...
        <Section label="02" title="COPY">
          <TextArea
            ...
            rows={2}
            placeholder="El festival confirma 12 nombres para la edición aniversario…"
          />
          <TextArea
            ...
            rows={6}
            placeholder="La organización publicó el anuncio esta mañana a través de…"
          />
        </Section>
        ...
        <Section label="04" title="MEDIA (opcional)">
          <ImageUrlField
