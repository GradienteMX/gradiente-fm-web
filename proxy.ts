...
// Next 16 "proxy" (formerly middleware). Runs on every request that matches `config.matcher` below. Refreshes
...
export const config = {
  ...
  // session state and adding the proxy noise just slows them down.
