...
export default function WelcomePage() {
  ...
  // If a ?codigo= param is present (user came from the invitation HTML),
  // auto-open the signup overlay with the code pre-filled so they can
  // complete registration without extra clicks.
  useEffect(() => {
