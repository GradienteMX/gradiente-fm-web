...
//
// Fase F: chrome only. Every [SIN REDACTAR] marker and every written
// paragraph below is unchanged prose — the page moved from the dark terminal
// register to the paper one, nothing was written or removed.
export default function ManifestoPage() {
  return (
    <>
      ...
      >
        <p className="border-l-2 border-ink pl-4 font-mono text-d13 italic leading-relaxed text-ink-faint">
        ...
        <p className="border-t border-ink pt-6 font-mono text-d11 uppercase leading-relaxed tracking-widest text-ink-faint">
          Versión <span className="text-ink">0.1</span> · borrador interno ·{' '}
